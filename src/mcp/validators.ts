import { SearchDocsInput, DownloadDocsInput, SearchSpecificDocsInput } from '../types/index.js';

export function validateSearchDocsInput(args: unknown): SearchDocsInput {
